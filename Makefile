...
pkgdatadir = $(datadir)/mcserver
pkgincludedir = $(includedir)/mcserver
pkglibdir = $(libdir)/mcserver
pkglibexecdir = $(libexecdir)/mcserver
...
OBJEXT = o
PACKAGE = mcserver
PACKAGE_BUGREPORT = vmizzle@gmail.com
PACKAGE_NAME = mcserver
PACKAGE_STRING = mcserver 0.1.0
PACKAGE_TARNAME = mcserver
PACKAGE_URL = 
